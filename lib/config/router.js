...
router.get('/atevent', function (req, res) {
    var data = {
        title: 'At The Event | NightlyBuild 2016 – Front End Conference in Cologne',
        page: 'atevent'
    };
...
router.get('/schedule', function (req, res) {
    var data = {
        title: 'Schedule | NightlyBuild 2016 – Front End Conference in Cologne',
        page: 'schedule'
    };
...
router.get('/location', function (req, res) {
    var data = {
        title: 'Location | NightlyBuild 2016 – Front End Conference in Cologne',
        page: 'location'
    };
...
router.get('/event', function (req, res) {
    var data = {
        title: 'Event Coverage | NightlyBuild 2016 – Front End Conference in Cologne',
        page: 'coc'
    };
...
router.get('/feedback', function (req, res) {
    res.redirect(301, 'https://docs.google.com/forms/d/1Nm4Z74mOOPl95rBxPtSYtXcE4Z22VcrfZt_cultOMv8/edit?usp=forms_home&ths=true');
});
*/
